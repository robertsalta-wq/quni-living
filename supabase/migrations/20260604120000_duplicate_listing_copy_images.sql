-- Duplicate listing: copy photos from source (landlords expect a full copy).
...
comment on function public.duplicate_property_listing(uuid) is
  'Landlord-only: draft copy of a listing (copies images, null availability), shared property_group_id when set.';
