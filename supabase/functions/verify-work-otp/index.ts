/**
 * Verify 6-digit OTP and mark work email verified on student_profiles.
 * Deploy: supabase functions deploy verify-work-otp
 */
...
Deno.serve(async (req) => {
  ...
  return json({ ok: true, work_email: row.email })
})
