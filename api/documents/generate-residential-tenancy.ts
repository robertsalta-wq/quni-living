...
import { runNswFt6600ListingTenancy } from '../lib/documents/listingTenancyGeneration/nswFt6600.js'
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  const result = await runNswFt6600ListingTenancy(admin, bookingId, { deferSigning })
