...
import { runVicForm1ListingTenancy } from '../lib/documents/listingTenancyGeneration/vicForm1.js'
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  const result = await runVicForm1ListingTenancy(admin, bookingId, { deferSigning })
