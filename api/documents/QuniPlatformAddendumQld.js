...
function Section8ConditionReport(_props) {
  return /* @__PURE__ */ jsxs4(View4, { style: { marginBottom: 10 }, children: [
    ...
    /* @__PURE__ */ jsxs4(Text4, { style: occupancyMatchPdf.bodyParagraph, children: [
      ...
      " ",
      /* @__PURE__ */ jsx4(Text4, { style: { fontFamily: "Helvetica-Bold" }, children: "section 65" }),
      " deals with the condition report at the start of a tenancy and ",
      /* @__PURE__ */ jsx4(Text4, { style: { fontFamily: "Helvetica-Bold" }, children: "section 66" }),
...
function Section9MoveOutProcedures(props) {
  ...
  return /* @__PURE__ */ jsxs4(View4, { style: { marginBottom: 10 }, children: [
    ...
    /* @__PURE__ */ jsx4(Text4, { style: [occupancyMatchPdf.bodyParagraph, { marginTop: 4 }], children: "The dollar amounts in the schedule below are commercial terms presented through the platform. They may only be enforced to the extent permitted by law; nothing in this schedule is intended to displace mandatory provisions of the Residential Tenancies and Rooming Accommodation Act 2008 (Qld)." }),
    /* @__PURE__ */ jsx4(Text4, { style: [occupancyMatchPdf.bodyParagraph, { marginTop: 4, fontFamily: "Helvetica-Bold" }], children: "Fee schedule (indicative - charged only where applicable and lawfully recoverable):" }),
    /* @__PURE__ */ jsx4(OccupancyMatchScheduleTable, { rows: feeRows.map((r) => ({ label: r.label, value: r.value })) }),
    /* @__PURE__ */ jsx4(Text4, { style: [occupancyMatchPdf.bodyParagraph, { marginTop: 4 }], children: "The tenant should supply a forwarding address and contact details for bond and correspondence. Bond release (if applicable) will follow Residential Tenancies Authority (RTA Queensland) requirements and any instructions given through the signing or bond workflow. The parties agree to cooperate promptly with reasonable requests for information needed to finalise the tenancy." })
  ] });
}
function Section10Bond(props) {
  ...
  return /* @__PURE__ */ jsxs4(View4, { style: { marginBottom: 10 }, children: [
    ...
    /* @__PURE__ */ jsx4(Text4, { style: occupancyMatchPdf.bodyParagraph, children: "Any bond paid or held for this tenancy is dealt with in accordance with the Residential Tenancies and Rooming Accommodation Act 2008 (Qld), the general tenancy agreement (Form 18a), and Residential Tenancies Authority (RTA Queensland) requirements (including bond lodgement and claim processes under Queensland law)." }),
    /* @__PURE__ */ jsxs4(Text4, { style: occupancyMatchPdf.bodyParagraph, children: [
...
function Section12Termination(_props) {
  return /* @__PURE__ */ jsxs4(View4, { style: { marginBottom: 10 }, children: [
    ...
    /* @__PURE__ */ jsx4(Text4, { style: occupancyMatchPdf.bodyParagraph, children: "This addendum does not override the Residential Tenancies and Rooming Accommodation Act 2008 (Qld) or the prescribed general tenancy agreement (Form 18a)." }),
    /* @__PURE__ */ jsxs4(Text4, { style: occupancyMatchPdf.bodyParagraph, children: [
    ...
    /* @__PURE__ */ jsxs4(Text4, { style: [occupancyMatchPdf.bodyParagraph, { marginTop: 6 }], children: [
      /* @__PURE__ */ jsx4(Text4, { style: { fontFamily: "Helvetica-Bold" }, children: "Leaving a fixed-term agreement early (reletting costs)" }),
      " - ",
      ...
      /* @__PURE__ */ jsx4(Text4, { style: { fontFamily: "Helvetica-Bold" }, children: "Section 357A" }),
      ...
      /* @__PURE__ */ jsx4(Text4, { style: { fontFamily: "Helvetica-Bold" }, children: "Section 362" }),
    ...
    /* @__PURE__ */ jsxs4(Text4, { style: occupancyMatchPdf.bodyParagraph, children: [
      ...
      " ",
      /* @__PURE__ */ jsx4(Text4, { style: { fontFamily: "Helvetica-Bold" }, children: "https://www.rta.qld.gov.au/ending-a-tenancy/ending-a-tenancy-agreement/reletting-costs" }),
      " ",
...
function Section15ElectronicExecution(_props) {
  return /* @__PURE__ */ jsxs4(View4, { style: { marginBottom: 10 }, children: [
    ...
    /* @__PURE__ */ jsxs4(Text4, { style: occupancyMatchPdf.bodyParagraph, children: [
      ...
      " ",
      /* @__PURE__ */ jsx4(Text4, { style: { fontFamily: "Helvetica-Bold" }, children: "Electronic Transactions (Queensland) Act 2001" }),
...
function QuniPlatformAddendumQld(props) {
  ...
  return /* @__PURE__ */ jsxs4(Document, { children: [
    /* @__PURE__ */ jsxs4(Page, { size: "A4", style: occupancyMatchPdf.page, children: [
      ...
      /* @__PURE__ */ jsx4(Text4, { style: occupancyMatchPdf.bodyParagraph, children: "This addendum records how the Quni platform is used for the tenancy described below. It is intended to be signed together with the prescribed general tenancy agreement (Form 18a) in the same package." }),
