...
/**
 * Generate NSW Standard Occupancy Agreement (boarding house) PDF, upload to Storage,
 * create tenancy rows, optionally send to DocuSeal.
 *
...
import { runNswBoardingHouseListingTenancy } from '../lib/documents/listingTenancyGeneration/nswBoardingHouse.js'
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  console.log('[generate-nsw-boarding-house] incoming request', { method: req.method })
  ...
  const result = await runNswBoardingHouseListingTenancy(admin, bookingId, { deferSigning })
