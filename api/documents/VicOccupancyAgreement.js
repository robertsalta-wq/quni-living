...
// src/lib/documents/vic/occupancyContent.ts
var VIC_LICENCE_OCCUPY_CONTENT = {
  ...
  bond: {
    ...
    intro: "Where a security deposit is agreed, it is held directly by the owner and is not lodged with any statutory bond authority.",
    bullets: [
  ...
  terminationNoStatutory: "This licence is not governed by the Residential Tenancies Act 1997 (Vic). The parties do not rely on prescribed residential tenancy notice periods or tribunal pathways under that Act.",
  aclParagraph: "Although the Residential Tenancies Act 1997 (Vic) does not apply, this licence is a consumer contract for the purposes of the Australian Consumer Law (Cth) as applied in Victoria. Terms that are unfair within the meaning of that law may be void. Neither party may engage in misleading or deceptive conduct in connection with this licence.",
  defaultHouseRules: [
  ...
  executionIntro: "The parties intend that electronic signing, where used, is valid and binding. Signature and date fields may be completed through a future signing workflow."
};

// src/lib/documents/vic/occupancyGenerator.tsx
import { jsx as jsx3 } from "react/jsx-runtime";
function VicLicenceToOccupyOnSite(props) {
  return /* @__PURE__ */ jsx3(LicenceOccupyDocument, { content: VIC_LICENCE_OCCUPY_CONTENT, props });
}
var occupancyGenerator_default = VicLicenceToOccupyOnSite;
export {
  VicLicenceToOccupyOnSite,
