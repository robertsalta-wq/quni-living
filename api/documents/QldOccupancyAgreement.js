...
function QldLicenceToOccupyOnSite(props) {
  return /* @__PURE__ */ jsx3(LicenceOccupyDocument, { content: QLD_LICENCE_OCCUPY_CONTENT, props });
}
function QuniOccupancyAgreementQld(props) {
  return QldLicenceToOccupyOnSite(props);
}
var occupancyGenerator_default = QldLicenceToOccupyOnSite;
export {
