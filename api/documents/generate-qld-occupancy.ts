...
import { QuniOccupancyAgreementQld } from './QuniOccupancyAgreementQld.js'
...
export default async function handler(req: any, res: any) {
  ...
  if (stateRaw !== 'QLD') {
    return res.status(400).json({ error: 'Property must be in Queensland for QLD occupancy PDF' })
  }
