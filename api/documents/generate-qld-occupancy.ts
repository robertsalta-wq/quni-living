...
import { runQldOccupancyListingTenancy } from '../lib/documents/listingTenancyGeneration/qldOccupancy.js'
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  console.log('[generate-qld-occupancy] incoming request', { method: req.method })
  ...
  const result = await runQldOccupancyListingTenancy(admin, bookingId, { deferSigning })
