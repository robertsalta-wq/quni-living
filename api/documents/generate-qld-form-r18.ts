...
/**
 * Generate Queensland Form R18 rooming accommodation agreement plus resident house-rules PDF.
 *
...
import { runQldFormR18ListingTenancy } from '../lib/documents/listingTenancyGeneration/qldFormR18.js'
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  console.log('[generate-qld-form-r18] incoming request', { method: req.method })
  ...
  const result = await runQldFormR18ListingTenancy(admin, bookingId, { deferSigning })
