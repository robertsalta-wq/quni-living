// src/lib/documents/QuniOccupancyAgreementQld.tsx
...
var cream = "#FAF6EE";
var creamLight = "#F5EDD8";
var terracotta = "#C9672A";
var body = "#2C2417";
var grey = "#6B6560";
var greyMuted = "#7A736C";
var white = "#FFFFFF";
  ...
  return R(
    ...
    R(
      ...
      R(
        ...
        R(Text, { style: styles.headerSubtitle }, "QLD \xB7 Residential Tenancies and Rooming Accommodation Act 2008 (Qld)")
      )
    ),
...
function FixedFooter({ documentId, generatedAt }) {
  return R(
    ...
    R(Text, {
      ...
      render: ({ pageNumber, totalPages }) => `Quni Living \xB7 Residential Occupancy Agreement \xB7 Document ID: ${documentId} \xB7 Generated: ${generatedAt} \xB7 Page ${pageNumber}` + (totalPages ? ` of ${totalPages}` : "")
    })
  );
}
function QuniOccupancyAgreementQld(props) {
  const {
    documentId,
    generatedAt,
    landlord,
  ...
  const houseRulesText = typeof houseRules === "string" && houseRules.trim().length > 0 ? houseRules : null;
  const landlordDisplay = landlord.companyName ? `${landlord.fullName} (${landlord.companyName})` : landlord.fullName;
  const bondText = bond.amount != null && Number.isFinite(bond.amount) ? formatMoney(bond.amount) : "As agreed (see bond schedule)";
  ...
  const preamble = "This is a Quni-authored Residential Occupancy Agreement for a boarder/lodger arrangement in Queensland. The Residential Tenancies and Rooming Accommodation Act 2008 (Qld) does not generally apply to this arrangement. This document records the agreed particulars between the landlord/provider and the resident, including rent, bond, term, and any special conditions set out below. Where this agreement is executed electronically, the parties intend that method of signing to be valid and binding.";
  ...
  return R(
      ...
      R(
        ...
        R(
          ...
          R(
            ...
            tenant.dateOfBirth ? R(Text, { style: styles.pTight }, `Date of birth: ${tenant.dateOfBirth}`) : null
          )
        )
      )
    ),
    ...
    R(
      ...
      R(
        Text,
        { style: styles.p },
        "The landlord lets and the resident takes the premises for use as a residence only, at the address shown in the summary. The arrangement includes the room and shared areas as described in the listing and on inspection."
      ),
      R(
        View,
        ...
        R(DataRow, {
          ...
          ].filter(Boolean).join(" \xB7 ") || "As per standard listing / inspection",
          alt: true
        })
      ),
      ...
      R(
        Text,
        { style: styles.p },
        "The arrangement commences on the start date in the summary and continues for the agreed term unless ended earlier in accordance with this agreement and applicable law."
      ),
      R(
        View,
        { style: styles.tableWrap },
        ...
        R(DataRow, {
          ...
          value: term.periodic ? "Yes \u2014 tenancy may continue as periodic after any fixed term, as allowed by law." : "As per Act if applicable.",
          alt: true
        })
      ),
    ...
    R(
      ...
      R(
        Text,
        { style: styles.p },
        "If rent is not paid on time, the landlord may take steps allowed under this agreement and applicable law, including seeking termination where grounds exist. Any rent increase requires the parties' agreement in writing unless otherwise required by law."
      ),
      R(SectionHeading, { num: 5, title: "Bond" }),
      R(
        Text,
        { style: styles.p },
        "This is a boarder/lodger arrangement. The Residential Tenancies and Rooming Accommodation Act 2008 (Qld) does not generally apply to this arrangement. However, any bond paid by the resident must be lodged with the Residential Tenancies Authority (RTA Queensland) within 10 days of receipt, in accordance with the bond lodgement requirements that apply to all rental bonds in Queensland. The landlord cannot hold the bond directly."
      ),
      R(
        View,
        { style: styles.noteBox },
        R(
          ...
          "The RTA Queensland publishes bond lodgement guidance under the RTRA Act 2008 (Qld), including s.116. The resident should retain evidence of payment and official lodgement confirmation."
        )
      ),
      ...
      R(
        Bullet,
        null,
        "Comply with this agreement and applicable law (including bond obligations under the RTRA Act 2008 (Qld) where they apply)."
      ),
      ...
      R(Bullet, null, "Comply with this agreement and applicable law.")
    ),
    /* —— Page 4 —— */
    R(
      Page,
      ...
      R(NumItem, {
        n: 2,
        children: "Subletting or assignment requires the landlord's prior written consent unless applicable law provides otherwise."
      }),
    ...
    R(
      ...
      R(
        Text,
        { style: styles.p },
        "The landlord may enter the premises only on lawful grounds and with reasonable notice as agreed or required by law, except in an emergency."
      ),
      R(
        View,
        { style: styles.tableWrap },
        ...
        R(TableRow, {
          cells: ["Routine inspection / condition report", "Reasonable notice (as agreed)", "As per house rules / this agreement"],
          odd: false
        }),
        R(TableRow, {
          cells: ["Carrying out repairs (non-urgent)", "Typically at least 24 hours", "Reasonable date/time"],
          odd: true
        }),
        R(TableRow, {
          cells: ["Showing premises to prospective tenant/buyer", "By agreement", "Limited periods before termination"],
          odd: false
        }),
      ...
      R(
        Text,
        { style: styles.p },
        "The tenant must notify the landlord of needed repairs. Urgent repairs may be arranged as permitted by law. Non-urgent repairs should be addressed within a reasonable time."
      ),
      R(
        View,
        { style: styles.noteBox },
    ...
    R(
      ...
      R(
        Text,
        { style: styles.p },
        "Termination is governed by this agreement and applicable Queensland law. The tables below are indicative only; they do not replace this agreement."
      ),
      ...
      R(
        ...
        R(TableRow, {
          cells: ["End of fixed term (tenant vacating)", "Notice as agreed in this agreement", "This agreement"],
          odd: false
        }),
        R(TableRow, {
          cells: ["Periodic / ongoing arrangement", "Notice as agreed or reasonable under general law", "This agreement"],
          odd: true
        }),
        R(TableRow, {
          cells: ["Breach by landlord", "Resident may seek remedies under applicable law", "General law"],
          odd: false
        }),
        R(TableRow, {
      ...
      R(
        ...
        R(TableHeader, { cells: ["Scenario", "Notice / action", "Reference"] }),
        R(TableRow, {
          cells: ["End of fixed term (no renewal)", "Notice as agreed in this agreement", "This agreement"],
          odd: false
        }),
        R(TableRow, {
          cells: ["Ongoing arrangement", "Notice as agreed or reasonable under general law", "This agreement"],
          odd: true
        }),
        R(TableRow, {
          cells: ["Breach by tenant", "Landlord may issue termination notice if grounds exist", "This agreement"],
          odd: false
        }),
        R(TableRow, {
          cells: ["Serious breach / non-payment", "Follow this agreement and applicable law", "General law"],
          odd: true
        })
      ),
      ...
      R(
        Text,
        { style: styles.pTight },
        "If the resident ends a fixed term early, any break fee applies only as agreed in this agreement or special conditions. Indicative schedule (contractual only, if incorporated):"
      ),
      R(
        View,
        { style: styles.tableWrap },
      ...
      R(
        ...
        R(
          Text,
          { style: styles.noteItalic },
          "This schedule applies only if adopted by the parties in special conditions or elsewhere in this document."
        )
      )
    ),
    /* —— Page 7 —— */
    R(
      ...
      R(
        Text,
        { style: styles.p },
        "The tenant must not transfer or sublet the whole or part of the premises without the landlord's written consent. Consent must not be unreasonably withheld where applicable law requires."
      ),
      ...
      R(
        Text,
        { style: styles.p },
        "Parties should attempt to resolve disputes in good faith. Either party may apply to the Queensland Civil and Administrative Tribunal (QCAT), or another forum with jurisdiction, for orders as permitted by law."
      ),
      ...
      R(
        Text,
        { style: styles.p },
        "Notices may be given by email to the addresses in Section 1 unless a party provides a different address for service in writing. The parties agree that the Electronic Transactions (Queensland) Act 2001 applies to electronic records and signatures where permitted."
      ),
      R(SectionHeading, { num: 19, title: "Special conditions and general" }),
      R(
        Text,
        { style: styles.p },
        "The following special conditions apply in addition to the preceding sections. If there is inconsistency, applicable law prevails to the extent required."
      ),
      specialConditions.length ? R(View, null, ...specialConditions.map((line, i) => R(Bullet, { key: i }, line))) : R(Text, { style: styles.p }, "No additional special conditions are recorded in this document."),
      bookingNotes ? R(
        View,
        { style: styles.noteBox },
...
export {
  QLD_OCCUPANCY_PDF_MARKERS,
  QuniOccupancyAgreementQld
};
