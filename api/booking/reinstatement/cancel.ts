...
import { cancelReinstatement } from '../../lib/booking/reinstatement/declineCancel.js'
...
export default async function handler(req: any, res: any) {
  ...
  try {
    ...
    const result = await cancelReinstatement({
      admin,
    ...
    console.error('[api/booking/reinstatement/cancel]', e)
