...
export const BOOKING_EVENT_TYPES = [
  ...
  'booking.termination_initiated',
  'booking.termination_acknowledged',
  'booking.termination_withdrawn',
  'booking.agreement_terminated',
  'bond.received_acknowledged',
  'bond.pending_cancelled_by_landlord',
  'bond.pending_expired',
  'bond.expiry_blocked_signed_lease',
  'booking.reinstatement_requested',
  'booking.reinstated_self_serve',
...
export const BOOKING_EVENT_DEFAULTS: Record<BookingEventType, BookingEventDefaults> = {
  ...
  'booking.termination_initiated': { audience: 'both', outcome: 'pending' },
  'booking.termination_acknowledged': { audience: 'both', outcome: 'success' },
  'booking.termination_withdrawn': { audience: 'both', outcome: 'n/a' },
  'booking.agreement_terminated': { audience: 'both', outcome: 'success' },
  ...
  'bond.expiry_blocked_signed_lease': { audience: 'internal', outcome: 'n/a' },
  'booking.reinstatement_requested': { audience: 'both', outcome: 'pending' },
  'booking.reinstated_self_serve': { audience: 'both', outcome: 'success' },
