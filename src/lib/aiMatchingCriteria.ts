...
export const STUDENT_PROFILE_FIELD_STATUS = {
  ...
  legal_name_set_by: 'NOT_MATCHING',
  legal_name_set_at: 'NOT_MATCHING',
  email: 'NOT_MATCHING',
  phone: 'NOT_MATCHING',
  gender: 'EXCLUDE',
  nationality: 'EXCLUDE',
  ...
  renter_situation: 'USE',
  employment_status: 'NOT_MATCHING',
  employer_name: 'NOT_MATCHING',
  job_title: 'NOT_MATCHING',
  employment_type: 'NOT_MATCHING',
  income_band: 'NOT_MATCHING',
  income_source: 'NOT_MATCHING',
  guarantor_relationship: 'NOT_MATCHING',
  guarantor_phone: 'NOT_MATCHING',
  guarantor_email: 'NOT_MATCHING',
  guarantor_income_band: 'NOT_MATCHING',
  guarantor_consent: 'NOT_MATCHING',
  visa_status: 'NOT_MATCHING',
  visa_subclass: 'NOT_MATCHING',
  visa_expiry: 'NOT_MATCHING',
...
export const BOOKING_FIELD_STATUS = {
  ...
  listing_acknowledged: 'NOT_MATCHING',
  ...
  termination_type: 'NOT_MATCHING',
  termination_effective_date: 'NOT_MATCHING',
  termination_reason_note: 'NOT_MATCHING',
  termination_initiated_by: 'NOT_MATCHING',
  termination_acknowledged_at: 'NOT_MATCHING',
  termination_initiated_at: 'NOT_MATCHING',
  bond_outcome: 'NOT_MATCHING',
  bond_outcome_note: 'NOT_MATCHING',
