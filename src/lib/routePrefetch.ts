...
const EXACT_PATH_IMPORTERS: Record<string, RouteImporter[]> = {
  ...
  '/landlords/co-living': [routeImports.coLivingLandingPage],
  '/landlords/co-living-electric': [routeImports.coLivingElectricLandingPage],
  ...
  '/landlord/profile': [routeImports.landlordDashboard],
  '/landlord/property/new': [routeImports.landlordPropertyFormPage],
...
export function prefetchRouteChunks(pathname: string): void {
  ...
  if (path.startsWith('/landlord/property/edit/')) {
