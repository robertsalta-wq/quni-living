/** Pre-sign-off: shown while legal review is in progress. */
export const LICENCE_OCCUPY_WATERMARK_PRE_SIGNOFF =
  'Subject to final legal review; terms may be updated with written notice'
