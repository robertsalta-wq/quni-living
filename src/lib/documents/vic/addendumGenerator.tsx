/**
 * Victoria platform addendum (Form 1 companion).
 */
...
import {
  ...
  VIC_ADDENDUM_SUBTITLE,
  VIC_CONDITION_REPORT_INTRO,
  VIC_CONDITION_REPORT_OUTGOING,
  VIC_CONDITION_REPORT_RETURN,
  VIC_DISPUTES_TRIBUNAL,
  VIC_ELECTRONIC_TRANSACTIONS_ACT,
  vicBondAuthorityLabel,
  vicBondAuthorityUrl,
  vicBondLodgementDeadlinePhrase,
  vicFeeFreeBankTransferParagraph,
} from './addendumContent.js'
  ...
  return (
    <View style={{ marginBottom: 10 }}>
      ...
      <Text style={occupancyMatchPdf.bodyParagraph}>
        ...
        {VIC_ADDENDUM_LEGISLATION} and {VIC_ADDENDUM_FORM_LABEL}.
      </Text>
      ...
      <Text style={occupancyMatchPdf.bodyParagraph}>
        ...
        The tenant pays no Quni platform fee, booking fee, or renter service fee; the tenant&apos;s agreed weekly rent is not
        increased by the landlord-side service fee.
      </Text>
  ...
  return (
    <View style={{ marginBottom: 10 }}>
      ...
      <Text style={occupancyMatchPdf.bodyParagraph}>
        ...
        in accordance with the {VIC_ADDENDUM_LEGISLATION}.
      </Text>
    </View>
  )
}
...
function Section8ConditionReport(_props: QuniPlatformAddendumProps) {
  return (
    <View style={{ marginBottom: 10 }}>
      ...
      <Text style={occupancyMatchPdf.bodyParagraph}>{VIC_CONDITION_REPORT_INTRO}</Text>

      <Text style={occupancyMatchPdf.bodyParagraph}>{VIC_CONDITION_REPORT_RETURN}</Text>

      <Text style={occupancyMatchPdf.bodyParagraph}>{VIC_CONDITION_REPORT_OUTGOING}</Text>
    </View>
  )
}
...
function Section9MoveOutProcedures(props: QuniPlatformAddendumProps) {
  ...
  return (
    <View style={{ marginBottom: 10 }}>
      ...
      <Text style={occupancyMatchPdf.bodyParagraph}>
        To end the tenancy, the tenant must give notice in accordance with the {VIC_ADDENDUM_LEGISLATION},{' '}
        {VIC_ADDENDUM_FORM_LABEL}, and any agreed notice period. Where the platform collects a move-out notice, the tenant
      ...
      <Text style={[occupancyMatchPdf.bodyParagraph, { marginTop: 4 }]}>
        ...
        applicable) will follow {vicBondAuthorityLabel()} requirements and any instructions given through the signing or bond
...
function Section10Bond(props: QuniPlatformAddendumProps) {
  ...
  return (
    <View style={{ marginBottom: 10 }}>
      ...
      <Text style={occupancyMatchPdf.bodyParagraph}>
        Any bond paid or held for this tenancy is dealt with in accordance with the {VIC_ADDENDUM_LEGISLATION},{' '}
        {VIC_ADDENDUM_FORM_LABEL}, and {authorityLabel} requirements
      ...
      <Text style={occupancyMatchPdf.bodyParagraph}>
        Bond lodgement and claim processes are administered by {authorityLabel}. Further information is available at{' '}
        <Text style={{ fontFamily: 'Helvetica-Bold' }}>{authorityUrl}</Text>.
      </Text>
  ...
  return (
    <View style={{ marginBottom: 10 }}>
      ...
      <Text style={occupancyMatchPdf.bodyParagraph}>
        ...
        compliance activities in accordance with the {VIC_ADDENDUM_LEGISLATION} and {VIC_ADDENDUM_FORM_LABEL}, including the
        rules about notice and reasonable grounds.
      </Text>
...
function Section12Termination(_props: QuniPlatformAddendumProps) {
  return (
    <View style={{ marginBottom: 10 }}>
      ...
      <Text style={occupancyMatchPdf.bodyParagraph}>
        This addendum does not override the {VIC_ADDENDUM_LEGISLATION} or {VIC_ADDENDUM_FORM_LABEL}.
      </Text>
      ...
      <Text style={occupancyMatchPdf.bodyParagraph}>
        ...
        {VIC_DISPUTES_TRIBUNAL}, hardship provisions where they apply, or other lawful pathways under the Act).
      </Text>
      ...
      <Text style={occupancyMatchPdf.bodyParagraph}>
        ...
        applicable, sale or demolition provisions where they apply, and tribunal orders). Mutual agreement to end can be
        recorded in writing at any time where the parties choose that path.
      </Text>

      <Text style={occupancyMatchPdf.bodyParagraph}>
        If anything in this addendum is inconsistent with the {VIC_ADDENDUM_LEGISLATION} or {VIC_ADDENDUM_FORM_LABEL}, the{' '}
...
function Section13Disputes(_props: QuniPlatformAddendumProps) {
  return (
    <View style={{ marginBottom: 10 }}>
      ...
      <Text style={occupancyMatchPdf.bodyParagraph}>
        Either party may apply to {VIC_DISPUTES_TRIBUNAL} for orders in accordance with the {VIC_ADDENDUM_LEGISLATION} and
        tribunal rules. Quni Living is <Text style={{ fontFamily: 'Helvetica-Bold' }}>not a party</Text> to VCAT proceedings
        between the landlord and tenant and <Text style={{ fontFamily: 'Helvetica-Bold' }}>cannot represent</Text> either party
        before VCAT.
      </Text>
    </View>
  )
  ...
  return (
    <View style={{ marginBottom: 10 }}>
      ...
      <Text style={occupancyMatchPdf.bodyParagraph}>
        ...
        <Text style={{ fontFamily: 'Helvetica-Bold' }}>{VIC_ELECTRONIC_TRANSACTIONS_ACT}</Text> and other applicable
...
export function QuniPlatformAddendumVic(props: QuniPlatformAddendumProps) {
    ...
    <Document>
      <Page size="A4" style={occupancyMatchPdf.page}>
        ...
        <Text style={occupancyMatchPdf.bodyParagraph}>
          ...
          to be signed together with the prescribed residential rental agreement (Form 1) in the same package.
        </Text>
...
export default QuniPlatformAddendumVic
