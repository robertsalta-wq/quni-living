/**
 * Quni Living — Queensland Residential Occupancy Agreement (boarder/lodger, React-PDF).
 * Bundled to `api/documents/QuniOccupancyAgreementQld.js`. Props match `rtaTypes.ts` OccupancyAgreementProps.
 */
// @ts-nocheck — large React-PDF document; same helper style as historical `OccupancyAgreement.js`
import React from 'react'
import { Document, Page, StyleSheet, Text, View } from '@react-pdf/renderer'
import type { OccupancyAgreementProps } from '../../../api/documents/rtaTypes.js'

/** Strings asserted in PDF generation tests (latin1 buffer search). */
...
function R(el: React.ElementType, props: Record<string, unknown> | null, ...children: unknown[]) {
  ...
  return R(
    ...
    R(
      ...
      R(
        ...
        R(Text, { style: styles.headerSubtitle }, 'QLD · Residential Tenancies and Rooming Accommodation Act 2008 (Qld)'),
      ),
    ),
...
/** Queensland boarder/lodger occupancy agreement (Quni-authored; not Form 18a). */
export function QuniOccupancyAgreementQld(props: OccupancyAgreementProps) {
  ...
  const preamble =
    'This is a Quni-authored Residential Occupancy Agreement for a boarder/lodger arrangement in Queensland. ' +
    'The Residential Tenancies and Rooming Accommodation Act 2008 (Qld) does not generally apply to this arrangement. ' +
    'This document records the agreed particulars between the landlord/provider and the resident, including rent, bond, term, and any special conditions set out below. ' +
  ...
  return R(
    ...
    R(
      ...
      R(NumItem, {
        n: 2,
        children:
          "Subletting or assignment requires the landlord's prior written consent unless applicable law provides otherwise.",
      }),
