...
export default function BookingsViewToggle({ value, onChange }: Props) {
  return (
    <div
      ...
      className="inline-flex w-full max-w-md rounded-[10px] border border-[#E5E4E7] bg-[#EFEDE6] p-[3px] sm:w-auto"
    >
        ...
        return (
          <button
            ...
            className={[
              ...
              active
                ? 'bg-white text-[#08060D] shadow-[0_1px_2px_rgba(8,6,13,0.08),0_1px_3px_rgba(8,6,13,0.06)]'
                : 'bg-transparent text-[#6B6375] hover:text-[#2A2433]',
            ].join(' ')}
          >
            {o.label}
          </button>
