...
export const ADMIN_NAV_ZONES: readonly AdminNavZone[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'document-access-log', label: 'Document access log', icon: 'file-text', to: '/admin/document-access-log' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'open-items', label: 'Open items', icon: 'bookmark', to: '/admin/open-items' },
