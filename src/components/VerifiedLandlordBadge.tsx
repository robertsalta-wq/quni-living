...
export function VerifiedLandlordBadge({ className = '' }: { className?: string }) {
  return (
    <span
      className={`inline-flex items-center gap-0.5 rounded-full bg-admin-coral/15 px-2 py-0.5 text-[11px] font-semibold leading-tight text-[var(--quni-coral)] ${className}`.trim()}
    >
