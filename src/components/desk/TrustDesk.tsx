  ...
  const face = (
    <>
      ...
      <div className="flex flex-col gap-1.5">
        {TRUST_LINES.map((t) => (
          <div key={t} className="flex items-center gap-2">
            <span
              aria-hidden
              className="inline-flex h-4 w-4 shrink-0 rotate-[-4deg] items-center justify-center rounded-[3px] border-[1.3px] border-[var(--quni-success)] bg-white/70 text-[10px] font-black text-[var(--quni-success)]"
            >
              ✓
            </span>
            <span className="text-[13.5px] font-medium text-[var(--quni-ink-2)]">{t}</span>
          </div>
        ))}
      </div>
      <div className="flex flex-wrap items-center gap-3">
        <Link
          to="/verification"
          className="text-[13px] font-semibold text-[var(--quni-success-strong)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--quni-success)]"
        >
        ...
        {!mobileRail ? (
          <button
            type="button"
            onClick={() => setOpen((v) => !v)}
            className="rounded-full border border-[rgba(29,158,117,0.22)] bg-white/60 px-3 py-1.5 text-[12px] font-semibold text-[var(--quni-success-strong)] hover:bg-[rgba(29,158,117,0.1)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--quni-success)]"
          >
