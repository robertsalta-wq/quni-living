...
export default function DeskPen({
  ...
  const base =
    'desk-pen inline-flex w-full items-center justify-center rounded-[var(--radius-md)] px-5 py-2.5 text-base font-bold transition-[transform,box-shadow,background-color] duration-[120ms] ease-[var(--ease-standard)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2'
