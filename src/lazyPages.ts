...
export const routeImports = {
  ...
  listYourRoom: () => import('./pages/ListYourRoom'),
  listYourRoomB: () => import('./pages/ListYourRoomB'),
  listYourRoomC: () => import('./pages/ListYourRoomC'),
  listYourRoomE: () => import('./pages/ListYourRoomE'),
  qldHouseRulesPage: () => import('./pages/QldHouseRulesPage'),
  ...
  adminOpenItems: () => import('./pages/admin/AdminOpenItems'),
  adminFeatureInventory: () => import('./pages/admin/AdminFeatureInventory'),
  adminLandlords: () => import('./pages/admin/AdminLandlords'),
  adminApps: () => import('./pages/admin/AdminApps'),
  adminSearch: () => import('./pages/admin/AdminSearch'),
...
export const ListYourRoom = lazy(routeImports.listYourRoom)
export const ListYourRoomB = lazy(routeImports.listYourRoomB)
export const ListYourRoomC = lazy(routeImports.listYourRoomC)
export const ListYourRoomE = lazy(routeImports.listYourRoomE)
export const QldHouseRulesPage = lazy(routeImports.qldHouseRulesPage)
...
export const AdminOpenItems = lazy(routeImports.adminOpenItems)
export const AdminFeatureInventory = lazy(routeImports.adminFeatureInventory)
export const AdminLandlords = lazy(routeImports.adminLandlords)
export const AdminApps = lazy(routeImports.adminApps)
export const AdminSearch = lazy(routeImports.adminSearch)
