...
export const routeImports = {
  ...
  homeV2: () => import('./pages/HomeV2'),
  homeV3: () => import('./pages/HomeV3'),
  homeV4: () => import('./pages/HomeV4'),
...
export const HomeV2 = lazy(routeImports.homeV2)
export const HomeV3 = lazy(routeImports.homeV3)
export const HomeV4 = lazy(routeImports.homeV4)
