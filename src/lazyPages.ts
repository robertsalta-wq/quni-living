...
export const routeImports = {
  ...
  coLivingLandingPage: () => import('./pages/landlords/CoLivingLandingPage'),
  coLivingElectricLandingPage: () => import('./pages/landlords/CoLivingElectricLandingPage'),
...
export const CoLivingLandingPage = lazy(routeImports.coLivingLandingPage)
export const CoLivingElectricLandingPage = lazy(routeImports.coLivingElectricLandingPage)
