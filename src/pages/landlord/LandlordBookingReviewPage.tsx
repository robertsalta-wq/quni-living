      ...
      <div className="mx-auto max-w-[1180px] px-6 py-6 pb-20">
        ...
        <div className="grid grid-cols-1 items-start gap-7 min-[921px]:grid-cols-[minmax(0,1fr)_356px]">
          ...
          <div className="order-first flex flex-col gap-4 min-[921px]:order-last min-[921px]:sticky min-[921px]:top-[calc(var(--site-header-height,5.5rem)+0.75rem)]">
            ...
            {booking.status === 'pending_confirmation' ? (
              showReadinessDriver || showReadinessReady || readinessNonGateBlockMessage ? (
            ...
            >
              {(() => {
                const resendBlock: ReactNode = showResendPaymentInstructions ? (
                ...
                if (primaryActionKind === 'bond-received') {
                  primaryBlock = (
                    <div className="space-y-2">
                      <button
                        type="button"
                ...
                } else if (primaryActionKind === 'mark-bond') {
                  primaryBlock = (
                    <div>
                      <button
                        type="button"
                ...
                } else if (booking.status === 'awaiting_info') {
                  primaryBlock = (
                ...
                if (!resendBlock && !primaryBlock) return undefined
                return (
                  <div className="space-y-3.5">
                    {resendBlock}
                    {primaryBlock}
            ...
            {primaryActionKind === 'bond-received' && bondDeadlineLabel ? (
            ...
            {primaryActionKind === 'bond-received' && isQldSchemeListing ? (
              <QldRtaLodgementGuidance />
            ) : null}

            {primaryActionKind === 'bond-received' && showRtaBondRecord ? (
              <div className="space-y-3 rounded-admin-md border border-admin-line bg-admin-surface-1 p-4">
            ...
            {booking.status === 'awaiting_info' && awaitingInfoQuestion ? (
