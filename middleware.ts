...
} from './src/lib/qldHouseRulesPageGateCore.js'
...
function isQldHouseRulesPageEnabledOnEdge(): boolean {
  const override =
    process.env.QLD_HOUSE_RULES_PAGE_ENABLED ?? process.env.VITE_QLD_HOUSE_RULES_PAGE_ENABLED ?? ''
